const { group, concat, softline, line, indent, join } = require('prettier').doc.builders;
const { EXPRESSION_NEEDED, STRING_NEEDS_QUOTES, wrapExpressionIfNeeded } = require('../util');
